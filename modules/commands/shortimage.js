module.exports.config = {
  ...
  usages: "shortimage a => [reply ảnhs/link ảnh (nếu nhiều link ngăn cách bằng " | ")] để thêm link cần short\nshortimage [link] để xóa short\nshortimage [all] để xem toàn bộ short",
  cooldowns: 5,
  dependencies: {
        "fs-extra": ""
    }
