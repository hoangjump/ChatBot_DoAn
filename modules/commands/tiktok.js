    ...
    case "info":
      ...
      try {
        axios.get(encodeURI(`https://caochungdat.me/docs/tiktok/infouser?user=${keyword}`)).then(async (res) => {
          ...
          const { followerCount, videoCount, heartCount, bioLink, followingCount } = res.data.data.stats;
