...
logger("Xin chao bạn dùng", "Người hướng dẫn");
logger("Chào mừng bạn tới với bảng điều khiển của bot", "Người hướng dẫn");
logger("Bạn có thể sửa chữa, thêm thắt trong bảng điều khiển này", "Người hướng dẫn");
logger("Vui lòng không xóa bất kì thứ gì tránh lỗi", "Người hướng dẫn");
logger("Nếu mọi thứ hoạt động không ổn định hãy dùng", "Người hướng dẫn");
logger("npm i (gói tài nguyên) thể thiết đặt lại", "Người hướng dẫn");
